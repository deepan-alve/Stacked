...
console.log('This script will help you create a .env file for your deployment.\n');
...
async function main() {
  ...
  if (config.TMDB_API_KEY || config.GOOGLE_API_KEY || config.GOOGLE_SEARCH_ENGINE_ID) {
  ...
  console.log(`TMDB API: ${config.TMDB_API_KEY ? '✅ Configured' : '❌ Not set'}`);
  console.log(`Google API: ${config.GOOGLE_API_KEY ? '✅ Configured' : '❌ Not set'}`);
  console.log('─────────────────────────────────────\n');
